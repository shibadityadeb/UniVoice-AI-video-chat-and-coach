        ...
        authClient.signUp.email(
          ...
          },
          {
            ...
            onError: (payload?: { error?: unknown }) => {
              reject(payload?.error ?? new Error("Sign up failed"));
            },
          }
        );
      });
              ...
              <div className='flex flex-col gap-6'>
                <div className='flex flex-col items-center text-center gap-1'>
                  ...
                  <p className='text-muted-foreground'>
                    Start building with UniVoice — create an account to continue
                  </p>
                </div>
                  ...
                  <FormField
                    ...
                    render={({field})=>(
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder='Your full name' className='h-10' {...field}/>
                        </FormControl>
                        <FormMessage/>
                      </FormItem>
                    )}
                ...
                <div className='text-center text-sm'>
                  Already have an account? <Link href='/sign-in' className='underline underline-offset-4 text-blue-700'>Sign in</Link>
                </div>
